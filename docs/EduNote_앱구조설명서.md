...
| `TRAINING_MATERIAL` | 연수자료 | 필수(연수목표·필요성·핵심내용·참고자료)에 선택 항목(연수 개요 표·사례와 판단기준·현장 실천사항·확인학습·한 장 요약)을 사용자가 체크한 것만 더해 구성. 대단원을 `Ⅰ.Ⅱ.Ⅲ.` 로마숫자로 써서 계획서(1.2.3.)와 구분되며 **예산 항목 없음**. 개조식 + 명사형 종결 |
