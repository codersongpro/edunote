...
- 가./나./다. 중항목은 한 항목이 그 자체로 읽고 이해되는 완결된 설명이어야 합니다. 주어·조건·행동과 학교 현장 적용 기준이 필요한 곳에서는 이를 분명히 드러내세요.
- "접근 권한 확인", "안전한 파기", "기록 관리 철저"처럼 두세 단어로 끝나는 제목·라벨식 항목은 절대 쓰지 마세요. 그런 표현은 뒤에 설명을 붙여 문장으로 만드세요.
- 설명이 더 필요한 중항목에는 1) 2) 3)으로 근거 규정, 판단 기준, 학교 현장의 구체적 상황, 자주 하는 실수를 덧붙이되, 내용이 없으면 하위 항목을 억지로 만들지 마세요.
...
- 개조식이어도 짧은 명사 나열로 설명을 대신하지 말고, 필요한 주어·조건·행동이 드러나는 완결된 설명을 허용하세요.
