...
const EXAMPLE_DOCS: Partial<Record<DocType, string>> = {
  ...
  [DocType.GONGMUN]: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:'맑은 고딕','Malgun Gothic',sans-serif;font-size:10.5pt;color:#111;background:#fff;padding:28px 36px;line-height:1.75}.doc-header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px}.org{font-size:15pt;font-weight:900;letter-spacing:2px}.docno{font-size:9pt;color:#555;text-align:right;line-height:1.6}.approval{display:flex;border:1px solid #555;width:220px;margin-left:auto;margin-bottom:14px}.apv-cell{flex:1;text-align:center;border-right:1px solid #555;padding:3px 0}.apv-cell:last-child{border-right:none}.apv-label{font-size:8pt;color:#555;border-bottom:1px solid #555;padding:2px 0}.apv-name{font-size:9.5pt;padding:10px 0 6px}.rule{border:none;border-top:2px solid #111;margin:4px 0 10px}.meta table{width:100%;border-collapse:collapse;margin-bottom:12px}.meta td{padding:3px 8px;vertical-align:top;font-size:10.5pt}.meta td.k{width:60px;font-weight:bold;white-space:nowrap}.meta td.v{border-bottom:1px solid #ddd}.body-text p{margin-bottom:7px;text-indent:0}.body-text .indent{padding-left:16px}.attach{margin-top:12px;font-size:10pt}.end{text-align:right;margin-top:6px;font-size:10pt}.sig-block{margin-top:32px;text-align:center;font-size:10.5pt;line-height:2.2}</style></head><body><div class="doc-header"><div class="org">○ ○ 초 등 학 교</div></div><div class="approval"><div class="apv-cell"><div class="apv-label">기안</div><div class="apv-name">홍길동</div></div><div class="apv-cell"><div class="apv-label">검토</div><div class="apv-name">이영희</div></div><div class="apv-cell"><div class="apv-label">결재</div><div class="apv-name">김교장</div></div></div><hr class="rule"><div class="meta"><table><tr><td class="k">수 신</td><td class="v">내부결재</td></tr><tr><td class="k">경 유</td><td class="v">&nbsp;</td></tr><tr><td class="k">제 목</td><td class="v">2026학년도 AI 디지털 소양 교육 운영 계획 수립</td></tr></table></div><div class="body-text"><p>1. 관련: 교육부 공문 교육혁신정책과-2026-103(2026.02.14.)</p><p>2. 위 관련과 관련하여 2026학년도 AI 디지털 소양 교육 운영 계획을 다음과 같이 수립하고자 합니다.</p><p class="indent">가. 대상: 전교생(1~6학년)</p><p class="indent">나. 기간: 2026. 3. ~ 12.(연중)</p><p class="indent">다. 내용: AI 기초 소양, 데이터 리터러시, 디지털 시민의식</p><div class="attach">붙 임&nbsp;&nbsp;2026학년도 AI 디지털 소양 교육 운영 계획서 1부.&nbsp;&nbsp;끝.</div></div><div class="sig-block">○ ○ 초 등 학 교 장</div></body></html>`,
