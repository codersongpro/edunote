...
const EXAMPLE_DOCS: Partial<Record<DocType, string>> = {
  ...
  [DocType.REPORT]: `<!DOCTYPE html><html><head><meta charset="utf-8"><title>Document</title></head><body><div style="font-family:'Dotum',sans-serif; font-size:13pt; line-height:1.6; color:#000000; max-width: 800px; margin: 0 auto;">    <!-- 문서 제목 영역 -->    <div style="text-align: center; margin-bottom: 30px;">        <h1 style="font-size: 22pt; font-weight: bold; margin-bottom: 10px;">2026학년도 교원 AI 활용 수업 역량 강화 연수 운영 결과 보고서</h1>        <p style="font-size: 14pt; font-style: italic; color: #4b5563; margin: 0;">- AI와 함께 열어가는 미래 교육, 교실 속 디지털 혁신의 첫걸음 -</p>    </div>    <!-- 1. 추진배경 -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">1. 추진배경</h2>        <div style="margin-left: 10px;">            가. 2022 개정 교육과정 도입에 따른 디지털 소양 교육 강화 및 AI 디지털교과서(AIDT) 현장 적용 대비 필요성 증대<br>            나. 인공지능(AI) 기술의 급격한 발전에 발맞추어 교원의 디지털 기반 교수·학습 설계 및 실행 역량 강화 요구<br>            다. 학생 맞춤형 개별화 교육 실현을 위한 교사의 AI 도구 활용 능력 및 에듀테크 활용 수업 전문성 신장 필요        </div>    </div>    <!-- 2. 목적 -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">2. 목적</h2>        <div style="margin-left: 10px;">            가. AI 및 에듀테크 도구를 활용한 맞춤형 수업 설계 및 평가 역량 강화<br>            나. 교실 수업 개선을 위한 교원 간 공동체적 연구 및 실천 문화 조성<br>            다. 디지털 대전환 시대에 부합하는 미래지향적 공교육 신뢰도 제고        </div>    </div>    <!-- 3. 운영방침 -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">3. 운영방침</h2>        <div style="margin-left: 10px;">            가. 본 연수는 전 교원을 대상으로 하며, 자발적 참여와 실습 중심의 워크숍 형태로 운영함.<br>            나. 학교 교육과정 운영에 지장이 없는 방과후 시간 및 전문적 학습공동체의 날을 활용하여 실시함.<br>            다. 연수 강사는 AI 교육 분야의 외부 전문가 및 교내 전문 교사를 초빙하여 전문성을 확보함.<br>            라. 연수 이수 시간에 대한 상시 연수 학점(직무연수 6시간) 이수 처리를 완료하였다.        </div>    </div>    <!-- 4. 세부추진계획(결과) -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">4. 세부추진 결과</h2>        <div style="margin-left: 10px;">            가. 연수 개요<br>            &nbsp;&nbsp;1) 일시: 2026년 4월 15일 ~ 6월 17일 (총 3회, 회당 2시간, 총 6시간)<br>            &nbsp;&nbsp;2) 대상: 전 교원 (총 20명 참석)<br>            &nbsp;&nbsp;3) 장소: 컴퓨터실 및 각 학년 연구실<br>            &nbsp;&nbsp;4) 방법: 대면 실습 및 토론 중심 워크숍<br>            <br>            나. 회차별 연수 세부 결과            <table border="1" style="border-collapse:collapse; width:100%; color:#000000; border:1px solid black; text-align:center; margin-top:10px; font-size:11pt;">                <thead>                    <tr style="background-color:#f3f4f6; font-weight:bold;">                        <th style="padding:8px; border:1px solid black; width:10%;">회차</th>                        <th style="padding:8px; border:1px solid black; width:15%;">일시</th>                        <th style="padding:8px; border:1px solid black; width:30%;">주제</th>                        <th style="padding:8px; border:1px solid black; width:35%;">주요 내용 및 결과</th>                        <th style="padding:8px; border:1px solid black; width:10%;">비고</th>                    </tr>                </thead>                <tbody>                    <tr>                        <td style="padding:8px; border:1px solid black;">1회차</td>                        <td style="padding:8px; border:1px solid black;">4.15.(수)</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">AI 교육의 이해와 트렌드</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">- 생성형 AI(ChatGPT, 뤼튼 등) 기초 실습<br>- 교육용 AI 도구의 윤리적 가이드라인 학습</td>                        <td style="padding:8px; border:1px solid black;">외부강사</td>                    </tr>                    <tr>                        <td style="padding:8px; border:1px solid black;">2회차</td>                        <td style="padding:8px; border:1px solid black;">5.20.(수)</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">AI 도구를 활용한 수업 설계</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">- 교과별 AI 활용 수업 지도안 작성 실습<br>- Canva, Gamma 활용 시각 자료 제작 완료</td>                        <td style="padding:8px; border:1px solid black;">내부강사</td>                    </tr>                    <tr>                        <td style="padding:8px; border:1px solid black;">3회차</td>                        <td style="padding:8px; border:1px solid black;">6.17.(수)</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">AI 기반 평가 및 피드백</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">- AI 평가 도구를 활용한 과정중심 평가 설계<br>- 학생 맞춤형 피드백 자동화 사례 공유</td>                        <td style="padding:8px; border:1px solid black;">내부강사</td>                    </tr>                </tbody>            </table>            <br>            다. 연수 운영 사진            <table border="1" style="border-collapse:collapse; width:100%; color:#000000; border:1px solid black; text-align:center; margin-top:10px; font-size:11pt;">                <tbody>                    <tr>                        <td style="padding:8px; border:1px solid black; width:50%; height:180px; vertical-align:middle; color:#6b7280;">                            [사진 첨부]<br><br>1회차 생성형 AI 기초 실습 및 윤리 교육 전경                        </td>                        <td style="padding:8px; border:1px solid black; width:50%; height:180px; vertical-align:middle; color:#6b7280;">                            [사진 첨부]<br><br>2회차 AI 활용 수업 지도안 작성 및 실습 장면                        </td>                    </tr>                    <tr>                        <td style="padding:8px; border:1px solid black; height:180px; vertical-align:middle; color:#6b7280;">                            [사진 첨부]<br><br>3회차 과정중심 평가 도구 실습 및 피드백 공유                        </td>                        <td style="padding:8px; border:1px solid black; height:180px; vertical-align:middle; color:#6b7280;">                            [사진 첨부]<br><br>연수 결과 종합 토론 및 소감 발표                        </td>                    </tr>                </tbody>            </table>        </div>    </div>    <!-- 페이지 분할선 -->    <hr style="page-break-after: always; border: none; border-top: 2px dashed #9ca3af; margin: 40px 0;">    <!-- 5. 소요예산 정산 -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">5. 소요예산 정산</h2>        <div style="margin-left: 10px;">            가. 총 집행액: 금500,000원 (금오십만원) - 집행률 100%<br>            나. 예산 과목: 학교운영비 - 교원연수운영 - 교원역량강화연수<br>            다. 세부 정산 내역            <table border="1" style="border-collapse:collapse; width:100%; color:#000000; border:1px solid black; text-align:center; margin-top:10px; font-size:11pt;">                <thead>                    <tr style="background-color:#f3f4f6; font-weight:bold;">                        <th style="padding:8px; border:1px solid black; width:15%;">목</th>                        <th style="padding:8px; border:1px solid black; width:15%;">세목</th>                        <th style="padding:8px; border:1px solid black; width:30%;">산출내역</th>                        <th style="padding:8px; border:1px solid black; width:12%;">계획액(원)</th>                        <th style="padding:8px; border:1px solid black; width:12%;">집행액(원)</th>                        <th style="padding:8px; border:1px solid black; width:10%;">잔액(원)</th>                        <th style="padding:8px; border:1px solid black; width:10%;">비고</th>                    </tr>                </thead>                <tbody>                    <tr>                        <td style="padding:8px; border:1px solid black;">강사료</td>                        <td style="padding:8px; border:1px solid black;">강사수당</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">외부 강사 초빙료<br>(150,000원 × 2시간)</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">300,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">300,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">0</td>                        <td style="padding:8px; border:1px solid black;">1회차</td>                    </tr>                    <tr>                        <td style="padding:8px; border:1px solid black;">수수료및임차료</td>                        <td style="padding:8px; border:1px solid black;">교재인쇄비</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">연수 교재 및 실습 자료 인쇄<br>(10,000원 × 10부)</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">100,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">100,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">0</td>                        <td style="padding:8px; border:1px solid black;">자체제작</td>                    </tr>                    <tr>                        <td style="padding:8px; border:1px solid black;">운영비</td>                        <td style="padding:8px; border:1px solid black;">급량비(다과)</td>                        <td style="padding:8px; border:1px solid black; text-align:left;">연수 참석자 다과 및 음료 구매<br>(5,000원 × 20명)</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">100,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">100,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">0</td>                        <td style="padding:8px; border:1px solid black;">-</td>                    </tr>                    <tr style="background-color:#f9fafb; font-weight:bold;">                        <td colspan="3" style="padding:8px; border:1px solid black; text-align:center;">합 계</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">500,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">500,000</td>                        <td style="padding:8px; border:1px solid black; text-align:right;">0</td>                        <td style="padding:8px; border:1px solid black;">-</td>                    </tr>                </tbody>            </table>        </div>    </div>    <!-- 6. 기대효과(성과) 및 제언 -->    <div style="margin-bottom: 25px;">        <h2 style="font-size: 15pt; font-weight: bold; margin-bottom: 10px;">6. 운영성과 및 제언</h2>        <div style="margin-left: 10px;">            가. 운영 성과<br>            &nbsp;&nbsp;1) 교원의 AI 및 에듀테크 활용 능력 향상으로 학생 맞춤형 개별화 수업 설계 능력 강화<br>            &nbsp;&nbsp;2) 디지털 기반의 다양한 수업 모델 개발 및 적용을 통해 교실 수업의 질적 개선 도모<br>            &nbsp;&nbsp;3) 미래 교육 환경 변화에 능동적으로 대처하는 교원의 전문성 및 디지털 교수 효능감 고취<br>            나. 제언 및 향후 계획<br>            &nbsp;&nbsp;1) 일회성 연수에 그치지 않도록 교내 전문적 학습공동체와 연계한 지속적인 수업 나눔 및 모니터링 필요<br>            &nbsp;&nbsp;2) 하반기에는 교과별 특성에 맞춘 심화 과정(교과별 AI 디지털교과서 활용 구체화) 연수 개설 검토 필요        </div>    </div></div></body></html>`,
