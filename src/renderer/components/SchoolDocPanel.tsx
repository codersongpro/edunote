...
const EXAMPLE_DOCS: Partial<Record<DocType, string>> = {
  ...
  [DocType.GONGMUN]: `<!DOCTYPE html><html><head><meta charset="utf-8"><style>*{box-sizing:border-box;margin:0;padding:0}body{font-family:'맑은 고딕','Malgun Gothic',sans-serif;font-size:10.5pt;color:#111;background:#fff;padding:28px 36px;line-height:1.75}.doc-header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:6px}.org{font-size:15pt;font-weight:900;letter-spacing:2px}.approval{display:flex;border:1px solid #555;width:220px;margin-left:auto;margin-bottom:14px}.apv-cell{flex:1;text-align:center;border-right:1px solid #555;padding:3px 0}.apv-cell:last-child{border-right:none}.apv-label{font-size:8pt;color:#555;border-bottom:1px solid #555;padding:2px 0}.apv-name{font-size:9.5pt;padding:10px 0 6px}.rule{border:none;border-top:2px solid #111;margin:4px 0 10px}.meta table{width:100%;border-collapse:collapse;margin-bottom:12px}.meta td{padding:3px 8px;vertical-align:top;font-size:10.5pt}.meta td.k{width:60px;font-weight:bold;white-space:nowrap}.meta td.v{border-bottom:1px solid #ddd}.body-text p{margin-bottom:7px}.body-text .indent{padding-left:16px}.attach{margin-top:12px;font-size:10pt}.sig-block{margin-top:32px;text-align:center;font-size:10.5pt;line-height:2.2}</style></head><body><div class="doc-header"><div class="org">○ ○ 초 등 학 교</div></div><div class="approval"><div class="apv-cell"><div class="apv-label">기안</div><div class="apv-name">홍길동</div></div><div class="apv-cell"><div class="apv-label">검토</div><div class="apv-name">이영희</div></div><div class="apv-cell"><div class="apv-label">결재</div><div class="apv-name">김교장</div></div></div><hr class="rule"><div class="meta"><table><tr><td class="k">수 신</td><td class="v">교육지원청 교육장</td></tr><tr><td class="k">경 유</td><td class="v">초등교육과장</td></tr><tr><td class="k">제 목</td><td class="v">2026년 학부모 공개수업 운영 결과 보고</td></tr></table></div><div class="body-text"><p>1. 관련: 초등교육과-2026-0421(2026.03.15.)</p><p>2. 위 관련에 의거 2026학년도 학부모 공개수업 운영 결과를 다음과 같이 보고합니다.</p><p class="indent">가. 일시: 2026. 4. 22.(화) 09:00~12:00</p><p class="indent">나. 참관 학부모 수: 총 187명(전체 가정 대비 참여율 72%)</p><p class="indent">다. 주요 내용: 2022 개정 교육과정 적용 수업 공개, 학부모 소통의 날 운영</p><div class="attach">붙 임&nbsp;&nbsp;2026학년도 학부모 공개수업 결과 보고서 1부.&nbsp;&nbsp;끝.</div></div><div class="sig-block">○ ○ 초 등 학 교 장</div></body></html>`,
