        ...
        <Section title="교무행정AI" icon={<FileText className="w-4 h-4 text-emerald-500" />}>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed mt-1">연수자료는 계획서와 같은 문서 양식을 쓰되 예산 항목 없이, 정보통신윤리교육·청렴교육처럼 교직원에게 실제로 교육할 수 있는 내용(교육 개요, 주요 교육 내용, 사례 및 판단 기준, 자가 점검표, 질의응답)을 개조식·명사형 문체로 작성합니다.</p>
