        ...
        <Section title="교무행정AI" icon={<FileText className="w-4 h-4 text-emerald-500" />}>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <p className="text-xs leading-relaxed mt-1">연수자료는 계획서의 내용 구성이 아니라 1. → 가. → 1) → 가) 말머리 체계만 따릅니다. 제목·기관명·충실한 연수 내용은 항상 만들고, 상황별 사례와 판단·실제 대응 절차·현장 체크리스트·근거 자료는 사용자가 체크한 경우에만 개조식·명사형 문체로 작성합니다.</p>
