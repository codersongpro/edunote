...
- 1. 추진배경: 가. 필요성, 나. 현황, 다. 추진 근거 또는 문제점
- 2. 목적: 가. 운영 목적, 나. 기대되는 변화, 다. 중점 방향
- 3. 운영방침: 가. 운영 원칙, 나. 대상 및 방법, 다. 관리 방안
- 4. 세부추진계획: 가. 운영 개요, 나. 세부 일정, 다. 세부 내용, 라. 역할 분담. 표가 필요한 내용은 표로 정리
- 5. 소요예산: 가. 예산 개요, 나. 산출 내역 표, 다. 집행 유의사항
- 6. 기대효과: 가. 학생 측면, 나. 교사 또는 학교 측면, 다. 향후 확산 측면
- 각 가. 나. 다. 항목은 1~2문장 이내의 보고서체로 작성하세요.
...
[개조식 작성 규칙] 표 앞뒤 설명도 긴 문단 금지. 각 항목은 반드시 가. 나. 다. 또는 표로 분리하세요.
